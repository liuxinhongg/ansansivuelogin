<template>
    <div id="BlacklistWorkers">
        <div class="title">
            <div class="title_1">工人黑名单管理</div>
        </div>
        <div class="khg">
          <p>证件编号：</p>
          <div class="ko">
        ...
        <el-dialog title="修改" :visible.sync="hand" width="40%">
          ...
          <el-form :model="tableData2" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
                   <el-form-item label="项目编号" prop="projectCode" :rules="[
                    ...
                    <el-form-item label="承包方组织机构代码" prop="departmentCode" :rules="[
                      { required: true, message: '请填承包方组织机构代码', trigger: 'blur' }
                    ...
                    <el-form-item label="企业组织机构代码" prop="subContractorCode"  :rules="[
                     ...
                     <el-form-item  label="证件类型" prop="credentialsId"  :rules="[
                      { required: true, message: '请填证件类型', trigger: 'blur' }

                  ]" >
                            <el-select disabled v-model="tableData2.credentialsId" placeholder="请选择" style="width:100%">
                          <el-option
                    ...
                    <el-form-item label="班组编号" prop="teamCode" :rules="[
                      { required: true, message: '请填班组编号', trigger: 'blur' }
                        ...
                        <el-input v-model="tableData2.teamCode"></el-input>
                    </el-form-item>
                     <el-form-item label="证件编号" prop="idCardNumber" :rules="[
                      { required: true, message: '请填证件编号', trigger: 'blur' }

                  ]">
                        <el-input v-model="tableData2.idCardNumber"></el-input>
                    </el-form-item>
        ...
        <el-table :data="tableData" style="width:100%;margin: auto;">
            <el-table-column prop="projectCode" :show-overflow-tooltip="true" label="项目编号 ">
            </el-table-column>
            <el-table-column prop="departmentCode" :show-overflow-tooltip="true" label="承包方组织机构代码">
            </el-table-column>
            <el-table-column prop="credentials.credentialsName" :show-overflow-tooltip="true" label="证件类型">
            </el-table-column>
            <el-table-column prop="idCardNumber"  :show-overflow-tooltip="true" label="证件编号">
            </el-table-column>
            <el-table-column prop="subContractorCode" :show-overflow-tooltip="true" label="企业组织机构代码">
            </el-table-column>
            <el-table-column prop="blackReason"  :show-overflow-tooltip="true" label="原因">
            </el-table-column>
              <el-table-column prop="teamCode" :show-overflow-tooltip="true" label="班组编号">
            </el-table-column>
  ...
  methods: {
   ...
   handleSizeChange(val) {
    ...
    query(){
      ...
      var that = this;
      that.axios
        .get("/apis/admin/workerBlackList/pageList", {
          params: {
            page:that.yeshuo,
            pageSize:that.tiao,
            idCardNumber:that.input10
    ...
    add() {
      ...
      that.axios
        .get("/apis/admin/workerBlackList/add", {
          params: {
    ...
    modify(){
      var that =this
      that.axios
        .get("/apis/admin/workerBlackList/update", {
          params: {
           projectCode:that.tableData2.projectCode,
             ...
             credentialsId:that.tableData2.credentialsId,
              idCardNumber:that.tableData2.idCardNumber,
             id:that.uid,
    ...
    handleDelete(row) {
      ...
      that.axios
        .get("/apis/admin/workerBlackList/delete", {
          params: {
             id:row.id,
          }
        })
